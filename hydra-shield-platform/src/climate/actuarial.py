...
- A bilingual (EN/AR) actuarial reference: the formulas and the insurance
  terminology an underwriter, reinsurer, broker or insurance office needs to
  read this profile.
...
# ---------------------------------------------------------------------------
# Actuarial reference — formulas + bilingual glossary
# ---------------------------------------------------------------------------

GLOSSARY_CATEGORIES: Dict[str, Dict[str, str]] = {
    "underwriting": {"en": "Underwriting", "ar": "الاكتتاب"},
    "pricing": {"en": "Pricing & rate-making", "ar": "التسعير وبناء الأقساط"},
    "reserving": {"en": "Reserving & claims", "ar": "المخصصات والمطالبات"},
    "reinsurance": {"en": "Reinsurance", "ar": "إعادة التأمين"},
    "solvency": {"en": "Solvency & regulation", "ar": "الملاءة والتنظيم"},
    "catastrophe": {"en": "Catastrophe modelling", "ar": "نمذجة الكوارث"},
    "policy": {"en": "Policy terms", "ar": "شروط الوثيقة"},
    "market": {"en": "Market & portfolio", "ar": "السوق والمحفظة"},
}
...
ACTUARIAL_FORMULAS: List[Dict[str, Any]] = [
    {
        ...
        "name_ar": "القسط الصافي (كلفة الخسارة)",
        "formula": "PP = f × E[X]",
    ...
    },
    {
        ...
        "use_ar": "تقلب الخسائر الإجمالية؛ يقود تحميلات الخطر ورأس المال.",
    },
    {
        "id": "compound_poisson_variance",
        "category": "pricing",
        "name_en": "Compound Poisson variance",
        "name_ar": "تباين بواسون المركب",
        "formula": "Var(S) = λ · E[X²]",
        ...
        "use_ar": "صيغة مغلقة للتباين عندما يكون العدد بواسوني — مستخدمة في العزوم الإجمالية لهذا الملف.",
    },
    {
        "id": "poisson_frequency",
        "category": "catastrophe",
        "name_en": "Poisson frequency law",
        "name_ar": "قانون التكرار البواسوني",
        ...
        "use_ar": "احتمال حدوث k حدث بالضبط في السنة؛ العمود الفقري للتكرار في تحليلات الكوارث.",
    },
    {
        "id": "annual_exceedance",
        "category": "catastrophe",
        "name_en": "Annual exceedance probability",
        "name_ar": "احتمال التجاوز السنوي",
        "formula": "P(N ≥ 1) = 1 − e^(−λ)",
        ...
        "use_ar": "احتمال حدوث حدث واحد على الأقل في السنة — وهو ما يقدّره هذا الملف لكل خطر.",
    },
    {
        "id": "return_period",
        "category": "catastrophe",
        "name_en": "Return period",
        "name_ar": "فترة العودة (فترة التكرار)",
        "formula": "T = 1 / p",
        "variables": {"p": "annual exceedance probability"},
        "use_en": "Average years between exceedances; a 1% AEP is the '100-year event'.",
        "use_ar": "متوسط السنوات بين حالتي تجاوز؛ احتمال 1% سنوياً يعني 'حدث المئة سنة'.",
    },
    {
        "id": "horizon_probability",
        "category": "catastrophe",
        "name_en": "Multi-year horizon probability",
        "name_ar": "احتمال التجاوز على أفق متعدد السنوات",
        ...
        "use_ar": "احتمال حدث واحد على الأقل خلال أفق الوثيقة أو القرض.",
    },
    {
        "id": "loss_ratio",
        "category": "pricing",
        ...
        "use_ar": "المقياس الأساسي لربحية محفظة أو اتفاقية إعادة تأمين.",
    },
    {
        "id": "combined_ratio",
        "category": "pricing",
        "name_en": "Combined ratio",
        "name_ar": "النسبة المجمعة",
        ...
        "use_ar": "أقل من 100% تعني ربحاً اكتتابياً؛ وأكثر من 100% تعني خسارة اكتتابية.",
    },
    {
        "id": "burning_cost",
        "category": "pricing",
        "name_en": "Burning cost",
        "name_ar": "التكلفة المحروقة (معدل الخسارة التاريخي)",
        ...
        "use_ar": "معدل الخسارة التاريخي لكل وحدة تعرّض؛ مرساة التسعير بالخبرة.",
    },
    {
        "id": "credibility",
        "category": "pricing",
        "name_en": "Credibility factor",
        "name_ar": "عامل المصداقية",
        ...
        "use_ar": "الوزن المعطى للخبرة الذاتية مقابل معدل المحفظة: التقدير = Z×الذاتية + (1−Z)×السابقة.",
    },
    {
        "id": "std_dev_principle",
        "category": "pricing",
        "name_en": "Standard-deviation premium principle",
        "name_ar": "مبدأ القسط بالانحراف المعياري",
        "formula": "P = E[S] + α · σ(S)",
        ...
        "use_ar": "يضيف تحميل خطر مبنياً على التقلب إلى القسط الصافي.",
    },
    {
        "id": "xl_recovery",
        "category": "reinsurance",
        "name_en": "Excess-of-loss recovery",
        "name_ar": "استرداد إعادة تأمين تجاوز الخسارة",
        ...
        "use_ar": "ما تدفعه اتفاقية تجاوز الخسارة عن خسارة L فوق نقطة الارتباط.",
    },
    {
        "id": "rate_on_line",
        "category": "reinsurance",
        "name_en": "Rate on line",
        "name_ar": "المعدل على الخط",
        ...
        "use_ar": "سعر وحدة الطاقة الكارثية؛ يقارن بالخسارة المتوقعة للطبقة للحكم على كفايته.",
    },
    {
        "id": "var_tvar",
        "category": "solvency",
        "name_en": "VaR / TVaR",
        "name_ar": "القيمة المعرضة للخطر / الشرطية",
        ...
        "use_ar": "مقاييس مخاطر الذيل؛ تحدد الملاءة II رأس المال عند VaR بنسبة 99.5% لسنة واحدة.",
    },
    {
        "id": "chain_ladder",
        "category": "reserving",
        "name_en": "Chain-ladder development",
        "name_ar": "طريقة السلسلة المتدرجة",
        ...
        "use_ar": "يسقط الخسائر النهائية من مثلثات التطور؛ الأداة الأساسية في تقدير المخصصات.",
    },
    {
        "id": "ep_curve",
        "category": "catastrophe",
        "name_en": "Exceedance-probability curve (OEP/AEP)",
        "name_ar": "منحنى احتمال التجاوز",
        ...
        "use_ar": "الرؤية الكاملة لتجاوز الخسائر في نموذج الكوارث؛ ومتوسط الخسارة السنوية هو المساحة تحته.",
    },
    {
        "id": "expected_value_principle",
        "category": "pricing",
        "name_en": "Expected-value premium principle",
        "name_ar": "مبدأ القسط بالقيمة المتوقعة",
        "formula": "Π = (1 + θ) · E[S]",
        ...
        "use_ar": "أبسط قاعدة تحميل: هامش نسبي فوق القسط الصافي.",
    },
    {
        "id": "vulnerability_curve",
        "category": "catastrophe",
        "name_en": "Vulnerability / damage function",
        "name_ar": "منحنى الهشاشة (دالة الضرر)",
        ...
        "use_ar": "يحول شدة الخطر إلى نسبة ضرر على القيمة المعرضة — وهو الجسر من الخطر إلى الخسارة في كل نماذج الكوارث.",
    },
    {
        "id": "negative_binomial",
        "category": "pricing",
        "name_en": "Negative-binomial frequency",
        "name_ar": "تكرار ذي الحدين السالب",
        "formula": "Var(N) = μ + μ² / r",
        ...
        "use_ar": "بديل فائض التشتت عن بواسون عندما يتجاوز تباين الأعداد المتوسط (محافظ غير متجانسة).",
    },
    {
        "id": "climate_conditioning",
        "category": "catastrophe",
        "name_en": "Climate conditioning of frequency",
        "name_ar": "التهيئة المناخية للتكرار",
        ...
        "use_ar": "يعدّل المعدلات التاريخية لمناخ غير مستقر بدل افتراض استمرار توزيع الماضي — الدفاع المعياري ضد فخ الاستقرار.",
    },
    {
        "id": "event_set_ep",
        "category": "catastrophe",
        "name_en": "EP curve from a stochastic event set",
        "name_ar": "منحنى التجاوز من مجموعة أحداث عشوائية",
        ...
        "use_ar": "كيف تبني نماذج الكوارث التجارية منحنى التجاوز: جمع احتمالات السيناريوهات فوق كل عتبة خسارة.",
    },
]

INSURANCE_GLOSSARY: List[Dict[str, str]] = [
    # -- underwriting -------------------------------------------------------
    {"id": "underwriting", "category": "underwriting", "term_en": "Underwriting", "term_ar": "الاكتتاب",
     "def_en": "The process of evaluating, selecting and pricing risks to insure.",
     "def_ar": "عملية تقييم المخاطر واختيارها وتسعيرها لقبول تأمينها."},
    {"id": "peril", "category": "underwriting", "term_en": "Peril", "term_ar": "الخطر المغطى",
     "def_en": "The cause of loss insured against (flood, wildfire, windstorm…).",
     "def_ar": "سبب الخسارة الذي يغطيه التأمين (فيضان، حريق، عاصفة…)."},
    {"id": "exposure", "category": "underwriting", "term_en": "Exposure", "term_ar": "التعرض",
     "def_en": "The assets, values or lives subject to a peril; the base to which rates apply.",
     "def_ar": "الأصول أو القيم أو الأرواح الخاضعة لخطر ما؛ وهي القاعدة التي تطبق عليها المعدلات."},
    {"id": "vulnerability", "category": "underwriting", "term_en": "Vulnerability", "term_ar": "الهشاشة",
     "def_en": "How much damage an asset suffers at a given hazard intensity (damage ratio).",
     "def_ar": "مقدار الضرر الذي يلحق بالأصل عند شدة معينة للخطر (نسبة الضرر)."},
    {"id": "insurability", "category": "underwriting", "term_en": "Insurability", "term_ar": "قابلية التأمين",
     "def_en": "Whether a risk meets the conditions to be insured: measurable, accidental, diversifiable, affordable.",
     "def_ar": "مدى استيفاء الخطر لشروط التأمين: قابل للقياس، عرضي، قابل للتنويع، وبقسط مقبول."},
    {"id": "moral_hazard", "category": "underwriting", "term_en": "Moral hazard", "term_ar": "الخطر الأخلاقي",
     "def_en": "Behaviour change after insurance that raises loss likelihood or size.",
     "def_ar": "تغير سلوك المؤمن له بعد التأمين بما يزيد احتمال الخسارة أو حجمها."},
    {"id": "adverse_selection", "category": "underwriting", "term_en": "Adverse selection", "term_ar": "الانتقاء المعاكس",
     "def_en": "Tendency of higher-risk parties to seek insurance more than lower-risk ones.",
     "def_ar": "ميل أصحاب المخاطر الأعلى لطلب التأمين أكثر من أصحاب المخاطر الأدنى."},
    {"id": "risk_appetite", "category": "underwriting", "term_en": "Risk appetite", "term_ar": "شهية المخاطر",
     "def_en": "The amount and type of risk an insurer is willing to accept.",
     "def_ar": "حجم ونوع المخاطر التي ترغب شركة التأمين في قبولها."},
    {"id": "accumulation", "category": "underwriting", "term_en": "Accumulation", "term_ar": "التراكم",
     "def_en": "Concentration of many insured risks exposed to the same event (e.g. one flood zone).",
     "def_ar": "تركز العديد من المخاطر المؤمنة المعرضة لنفس الحدث (كمنطقة فيضان واحدة)."},
    # -- pricing ------------------------------------------------------------
    {"id": "pure_premium", "category": "pricing", "term_en": "Pure premium", "term_ar": "القسط الصافي",
     "def_en": "Frequency × severity: the expected loss cost per exposure unit, before loadings.",
     "def_ar": "التكرار × الشدة: كلفة الخسارة المتوقعة لكل وحدة تعرض، قبل التحميلات."},
    {"id": "frequency", "category": "pricing", "term_en": "Frequency", "term_ar": "التكرار",
     "def_en": "Expected number of loss events per period (usually per year).",
     "def_ar": "العدد المتوقع لأحداث الخسارة في الفترة (عادة سنوياً)."},
    {"id": "severity", "category": "pricing", "term_en": "Severity", "term_ar": "الشدة",
     "def_en": "The size of loss given that an event occurred.",
     "def_ar": "حجم الخسارة بشرط وقوع الحدث."},
    {"id": "loss_ratio", "category": "pricing", "term_en": "Loss ratio", "term_ar": "نسبة الخسائر",
     "def_en": "Incurred losses divided by earned premium; core profitability measure.",
     "def_ar": "الخسائر المتكبدة مقسومة على الأقساط المكتسبة؛ مقياس الربحية الأساسي."},
    {"id": "combined_ratio", "category": "pricing", "term_en": "Combined ratio", "term_ar": "النسبة المجمعة",
     "def_en": "Loss ratio plus expense ratio; below 100% is an underwriting profit.",
     "def_ar": "نسبة الخسائر مضافاً إليها نسبة المصاريف؛ أقل من 100% تعني ربحاً اكتتابياً."},
    {"id": "burning_cost", "category": "pricing", "term_en": "Burning cost", "term_ar": "التكلفة المحروقة",
     "def_en": "Historical losses per unit of exposure; the experience-rating anchor.",
     "def_ar": "الخسائر التاريخية لكل وحدة تعرض؛ مرساة التسعير بالخبرة."},
    {"id": "credibility", "category": "pricing", "term_en": "Credibility", "term_ar": "المصداقية",
     "def_en": "Statistical weight given to an account's own experience versus the portfolio rate.",
     "def_ar": "الوزن الإحصائي المعطى لخبرة الحساب الذاتية مقابل معدل المحفظة."},
    {"id": "expense_loading", "category": "pricing", "term_en": "Expense loading", "term_ar": "تحميل المصاريف",
     "def_en": "Premium component covering acquisition, administration and overheads.",
     "def_ar": "مكوّن القسط الذي يغطي الاكتساب والإدارة والمصاريف العامة."},
    {"id": "risk_loading", "category": "pricing", "term_en": "Risk loading", "term_ar": "تحميل الخطر",
     "def_en": "Premium margin above expected loss compensating volatility and uncertainty.",
     "def_ar": "هامش فوق الخسارة المتوقعة يعوّض التقلب وعدم اليقين."},
    # -- reserving ----------------------------------------------------------
    {"id": "ibnr", "category": "reserving", "term_en": "IBNR", "term_ar": "الخسائر المتكبدة غير المبلغ عنها",
     "def_en": "Incurred but not reported: reserves for claims that happened but are not yet filed.",
     "def_ar": "مخصصات لمطالبات وقعت لكنها لم تُبلّغ بعد."},
    {"id": "case_reserves", "category": "reserving", "term_en": "Case reserves", "term_ar": "مخصصات الحالات الفردية",
     "def_en": "Reserves set claim-by-claim for reported cases.",
     "def_ar": "مخصصات تُقدّر لكل مطالبة مبلّغة على حدة."},
    {"id": "loss_development", "category": "reserving", "term_en": "Loss development", "term_ar": "تطور الخسائر",
     "def_en": "How claim amounts grow over time until final settlement (triangles, chain-ladder).",
     "def_ar": "كيفية نمو مبالغ المطالبات مع الوقت حتى التسوية النهائية (المثلثات والسلسلة المتدرجة)."},
    {"id": "claims_triangle", "category": "reserving", "term_en": "Claims triangle", "term_ar": "مثلث المطالبات",
     "def_en": "Accident-year × development-year table of cumulative claims used for reserving.",
     "def_ar": "جدول سنة الحادث × سنة التطور للمطالبات التراكمية المستخدم في تقدير المخصصات."},
    # -- reinsurance --------------------------------------------------------
    {"id": "reinsurance", "category": "reinsurance", "term_en": "Reinsurance", "term_ar": "إعادة التأمين",
     "def_en": "Insurance for insurers: ceding part of the risk to another carrier.",
     "def_ar": "تأمين لشركات التأمين: التنازل عن جزء من الخطر لجهة أخرى."},
    {"id": "cedant", "category": "reinsurance", "term_en": "Cedant", "term_ar": "الشركة المتنازلة",
     "def_en": "The insurer that transfers (cedes) risk to a reinsurer.",
     "def_ar": "شركة التأمين التي تنقل (تتنازل عن) الخطر إلى معيد التأمين."},
    {"id": "quota_share", "category": "reinsurance", "term_en": "Quota share", "term_ar": "إعادة التأمين النسبية",
     "def_en": "Proportional treaty: reinsurer takes a fixed percentage of every risk and premium.",
     "def_ar": "اتفاقية تناسبية: يأخذ المعيد نسبة ثابتة من كل خطر وقسط."},
    {"id": "excess_of_loss", "category": "reinsurance", "term_en": "Excess of loss (XL)", "term_ar": "إعادة تأمين تجاوز الخسارة",
     "def_en": "Non-proportional cover paying losses above an attachment point up to a limit.",
     "def_ar": "تغطية غير تناسبية تدفع الخسائر فوق نقطة الارتباط وحتى حد معين."},
    {"id": "attachment_point", "category": "reinsurance", "term_en": "Attachment point", "term_ar": "نقطة الارتباط",
     "def_en": "Loss level at which an XL treaty starts to pay.",
     "def_ar": "مستوى الخسارة الذي تبدأ عنده اتفاقية تجاوز الخسارة بالدفع."},
    {"id": "retention", "category": "reinsurance", "term_en": "Retention", "term_ar": "مبلغ الاحتفاظ",
     "def_en": "The share of risk the insurer keeps for its own account.",
     "def_ar": "حصة الخطر التي تحتفظ بها شركة التأمين لحسابها الخاص."},
    {"id": "stop_loss", "category": "reinsurance", "term_en": "Stop loss", "term_ar": "وقف الخسارة",
     "def_en": "Cover that caps the cedant's aggregate losses over a period.",
     "def_ar": "تغطية تحدّ الخسائر الإجمالية للمتنازل خلال فترة معينة."},
    {"id": "retrocession", "category": "reinsurance", "term_en": "Retrocession", "term_ar": "إعادة الإسناد",
     "def_en": "Reinsurance of a reinsurer — passing risk further up the chain.",
     "def_ar": "إعادة تأمين معيد التأمين — تمرير الخطر إلى مستوى أعلى في السلسلة."},
    {"id": "rate_on_line", "category": "reinsurance", "term_en": "Rate on line", "term_ar": "المعدل على الخط",
     "def_en": "Reinsurance premium divided by the layer limit; the price of cat capacity.",
     "def_ar": "قسط إعادة التأمين مقسوماً على حد الطبقة؛ سعر الطاقة الكارثية."},
    {"id": "reinstatement", "category": "reinsurance", "term_en": "Reinstatement", "term_ar": "إعادة التفعيل",
     "def_en": "Restoring an XL layer after it is exhausted, usually for an extra premium.",
     "def_ar": "استعادة طبقة تجاوز الخسارة بعد استنفادها، عادة مقابل قسط إضافي."},
    {"id": "ils", "category": "reinsurance", "term_en": "ILS / cat bond", "term_ar": "الأوراق المالية المرتبطة بالتأمين / سندات الكوارث",
     "def_en": "Capital-market instruments transferring insurance risk to investors.",
     "def_ar": "أدوات أسواق رأس المال التي تنقل مخاطر التأمين إلى المستثمرين."},
    # -- solvency -----------------------------------------------------------
    {"id": "solvency_ii", "category": "solvency", "term_en": "Solvency II", "term_ar": "الملاءة II",
     "def_en": "EU prudential regime: risk-based capital, governance and disclosure for insurers.",
     "def_ar": "النظام الاحترازي الأوروبي: رأس مال قائم على المخاطر وحوكمة وإفصاح لشركات التأمين."},
    {"id": "scr", "category": "solvency", "term_en": "SCR", "term_ar": "متطلبات رأس المال للملاءة",
     "def_en": "Solvency Capital Requirement: capital to withstand a 1-in-200 year loss over one year (99.5% VaR).",
     "def_ar": "رأس المال اللازم لتحمل خسارة سنة من كل 200 سنة (VaR عند 99.5%)."},
    {"id": "orsa", "category": "solvency", "term_en": "ORSA", "term_ar": "التقييم الذاتي للمخاطر والملاءة",
     "def_en": "Own Risk and Solvency Assessment: the insurer's internal view of its risks and capital needs.",
     "def_ar": "تقييم شركة التأمين الداخلي لمخاطرها واحتياجاتها من رأس المال."},
    {"id": "var", "category": "solvency", "term_en": "Value at Risk (VaR)", "term_ar": "القيمة المعرضة للخطر",
     "def_en": "Loss quantile at a confidence level (e.g. the 99.5% worst-case loss).",
     "def_ar": "كميل الخسارة عند مستوى ثقة معين (مثلاً أسوأ خسارة عند 99.5%)."},
    {"id": "tvar", "category": "solvency", "term_en": "TVaR / expected shortfall", "term_ar": "القيمة المعرضة للخطر الشرطية",
     "def_en": "Expected loss given the VaR threshold is breached; a tail-sensitive measure.",
     "def_ar": "الخسارة المتوقعة بشرط تجاوز عتبة VaR؛ مقياس حساس للذيل."},
    {"id": "risk_margin", "category": "solvency", "term_en": "Risk margin", "term_ar": "هامش المخاطر",
     "def_en": "Solvency II addition to best-estimate liabilities for the cost of holding capital.",
     "def_ar": "إضافة في الملاءة II إلى أفضل تقدير للالتزامات مقابل كلفة الاحتفاظ برأس المال."},
    # -- catastrophe --------------------------------------------------------
    {"id": "cat_model", "category": "catastrophe", "term_en": "Catastrophe model", "term_ar": "نموذج الكوارث",
     "def_en": "Simulation framework of hazard × exposure × vulnerability × financial modules producing loss distributions.",
     "def_ar": "إطار محاكاة: الخطر × التعرض × الهشاشة × الوحدة المالية لإنتاج توزيعات الخسارة."},
    {"id": "aal", "category": "catastrophe", "term_en": "AAL", "term_ar": "متوسط الخسارة السنوية",
     "def_en": "Average annual loss: the long-run mean loss per year (area under the EP curve).",
     "def_ar": "متوسط الخسارة السنوية على المدى الطويل (المساحة تحت منحنى احتمال التجاوز)."},
    {"id": "pml", "category": "catastrophe", "term_en": "PML", "term_ar": "الخسارة القصوى المحتملة",
     "def_en": "Probable maximum loss: the loss at a chosen return period (e.g. 250-year).",
     "def_ar": "الخسارة عند فترة عودة مختارة (مثلاً 250 سنة)."},
    {"id": "ep_curve", "category": "catastrophe", "term_en": "EP curve", "term_ar": "منحنى احتمال التجاوز",
     "def_en": "Probability of exceeding each loss level; OEP per event, AEP across all events in a year.",
     "def_ar": "احتمال تجاوز كل مستوى خسارة؛ OEP لكل حدث وAEP لكل أحداث السنة."},
    {"id": "ground_up_loss", "category": "catastrophe", "term_en": "Ground-up loss", "term_ar": "الخسارة من الأساس",
     "def_en": "Total loss before any policy terms, deductibles or reinsurance.",
     "def_ar": "الخسارة الكلية قبل أي شروط وثيقة أو تحملات أو إعادة تأمين."},
    {"id": "return_period", "category": "catastrophe", "term_en": "Return period", "term_ar": "فترة العودة",
     "def_en": "Average years between events of a given size; reciprocal of the annual exceedance probability.",
     "def_ar": "متوسط السنوات بين أحداث بحجم معين؛ مقلوب احتمال التجاوز السنوي."},
    {"id": "secondary_uncertainty", "category": "catastrophe", "term_en": "Secondary uncertainty", "term_ar": "عدم اليقين الثانوي",
     "def_en": "Uncertainty in loss given the event occurred (vs primary uncertainty of occurrence).",
     "def_ar": "عدم اليقين في الخسارة بشرط وقوع الحدث (مقابل عدم اليقين الأولي في الوقوع)."},
    # -- policy -------------------------------------------------------------
    {"id": "sum_insured", "category": "policy", "term_en": "Sum insured", "term_ar": "مبلغ التأمين",
     "def_en": "Maximum amount payable under a policy; the exposure base.",
     "def_ar": "الحد الأقصى للمبلغ المدفوع بموجب الوثيقة؛ وهو قاعدة التعرض."},
    {"id": "deductible", "category": "policy", "term_en": "Deductible", "term_ar": "مبلغ التحمل",
     "def_en": "The part of each loss the policyholder bears before the insurer pays.",
     "def_ar": "الجزء من كل خسارة يتحمله المؤمن له قبل أن تدفع الشركة."},
    {"id": "policy_limit", "category": "policy", "term_en": "Policy limit / sublimit", "term_ar": "حد الوثيقة / الحد الفرعي",
     "def_en": "Cap on the insurer's payment, overall or for a specific peril or item.",
     "def_ar": "سقف دفع شركة التأمين، إجمالاً أو لخطر أو بند محدد."},
    {"id": "exclusion", "category": "policy", "term_en": "Exclusion", "term_ar": "الاستثناء",
     "def_en": "Perils or circumstances the policy does not cover.",
     "def_ar": "أخطار أو ظروف لا تغطيها الوثيقة."},
    {"id": "coinsurance", "category": "policy", "term_en": "Coinsurance", "term_ar": "التأمين المشترك",
     "def_en": "Sharing of risk between insurers, or a clause penalising under-insurance.",
     "def_ar": "اقتسام الخطر بين عدة مؤمنين، أو شرط يجازي على التأمين بأقل من القيمة."},
    # -- market -------------------------------------------------------------
    {"id": "protection_gap", "category": "market", "term_en": "Protection gap", "term_ar": "فجوة الحماية التأمينية",
     "def_en": "Difference between economic losses and insured losses for a peril or region.",
     "def_ar": "الفرق بين الخسائر الاقتصادية والخسائر المؤمنة لخطر أو منطقة."},
    {"id": "penetration", "category": "market", "term_en": "Insurance penetration", "term_ar": "اختراق التأمين",
     "def_en": "Premiums as a share of GDP; how deeply insurance reaches an economy.",
     "def_ar": "الأقساط كنسبة من الناتج المحلي؛ مدى عمق وصول التأمين إلى الاقتصاد."},
    {"id": "capacity", "category": "market", "term_en": "Capacity", "term_ar": "الطاقة الاستيعابية",
     "def_en": "Amount of risk the market (or one carrier) is willing and able to write.",
     "def_ar": "حجم المخاطر الذي يرغب السوق (أو شركة ما) ويستطيع اكتتابه."},
    {"id": "hard_soft_market", "category": "market", "term_en": "Hard / soft market", "term_ar": "السوق الصعبة / السهلة",
     "def_en": "Market cycle: hard = rising prices and tight capacity; soft = falling prices and abundant capacity.",
     "def_ar": "دورة السوق: صعبة = أسعار مرتفعة وطاقة شحيحة؛ سهلة = أسعار منخفضة وطاقة وفيرة."},
    # -- catastrophe / climate analytics additions --------------------------
    {"id": "damage_ratio", "category": "catastrophe", "term_en": "Damage ratio (MDR)", "term_ar": "نسبة الضرر",
     ...
     "def_ar": "كلفة الإصلاح أو الاستبدال كنسبة من القيمة المعرضة عند شدة معينة — المحور العمودي لمنحنى الهشاشة."},
    {"id": "vulnerability_curve_term", "category": "catastrophe", "term_en": "Vulnerability curve", "term_ar": "منحنى الهشاشة",
     "def_en": "Function mapping hazard intensity (flood depth, wind speed, FWI) to the mean damage ratio of an asset class.",
     "def_ar": "دالة تربط شدة الخطر (عمق الفيضان، سرعة الرياح، مؤشر FWI) بنسبة الضرر المتوسطة لفئة الأصول."},
    {"id": "exposure_value", "category": "underwriting", "term_en": "Exposure value", "term_ar": "القيمة المعرضة",
     "def_en": "The monetary value at risk (building, contents, business interruption) to which damage ratios apply.",
     "def_ar": "القيمة النقدية المعرضة للخطر (مبنى، محتويات، انقطاع أعمال) التي تُطبق عليها نسب الضرر."},
    {"id": "stochastic_event_set", "category": "catastrophe", "term_en": "Stochastic event set", "term_ar": "مجموعة الأحداث العشوائية",
     "def_en": "Thousands of simulated catastrophe scenarios with annual probabilities, the engine of vendor cat models.",
     "def_ar": "آلاف السيناريوهات الكارثية المحاكاة باحتمالات سنوية، وهي محرك نماذج الكوارث التجارية."},
    {"id": "non_stationarity", "category": "catastrophe", "term_en": "Non-stationarity", "term_ar": "عدم الاستقرار (اللاثبات)",
     "def_en": "When the loss distribution itself shifts over time (climate change) — historical rates alone understate future risk.",
     "def_ar": "حين يتغير توزيع الخسارة ذاته مع الزمن (تغير المناخ) — فالمعدلات التاريخية وحدها تقلل من خطر المستقبل."},
    {"id": "scenario_analysis", "category": "catastrophe", "term_en": "Climate scenario analysis", "term_ar": "تحليل السيناريوهات المناخية",
     "def_en": "Re-estimating frequencies/severities under IPCC pathways (SSP1-2.6 … SSP5-8.5) for stress tests and ORSA.",
     "def_ar": "إعادة تقدير التكرار والشدة تحت مسارات IPCC لاختبارات الإجهاد والتقييم الذاتي للملاءة."},
    {"id": "glm", "category": "pricing", "term_en": "GLM (generalized linear model)", "term_ar": "النماذج الخطية المعممة",
     "def_en": "The rating workhorse: log-link Poisson/gamma regressions pricing frequency and severity by risk factors.",
     "def_ar": "أداة التسعير الأساسية: انحدارات بواسون/غاما بوصلة لوغاريتمية تسعّر التكرار والشدة حسب عوامل الخطر."},
    {"id": "negative_binomial_term", "category": "pricing", "term_en": "Negative binomial", "term_ar": "التوزيع ذو الحدين السالب",
     "def_en": "Over-dispersed count distribution for claim frequency when variance exceeds the mean.",
     "def_ar": "توزيع أعداد فائض التشتت لتكرار المطالبات عندما يتجاوز التباين المتوسط."},
    {"id": "reporting_bias", "category": "catastrophe", "term_en": "Reporting / detection bias", "term_ar": "انحياز الرصد والإبلاغ",
     ...
     "def_ar": "اتجاهات ظاهرية سببها تحسن الرصد أو الإبلاغ لا اتجاه فيزيائي حقيقي — تُفصح دائماً بجانب تقديرات الاتجاه."},
    {"id": "cte", "category": "solvency", "term_en": "CTE (conditional tail expectation)", "term_ar": "التوقع الشرطي للذيل",
     "def_en": "Alias of TVaR: the mean loss beyond the VaR threshold.",
     "def_ar": "مرادف TVaR: متوسط الخسارة بعد عتبة القيمة المعرضة للخطر."},
]
