...
notifications (SMS + email, per user preferences) on meaningful severity
transitions — upward threshold crossings and downward recoveries. Intended
...
from src.dashboard.alert_engine import process_rule  # noqa: E402
