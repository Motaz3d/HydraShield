        ...
        government: {
            ...
            extra: {
                ...
                cards: [
                    ...
                    ['4 · Resilience solutions', 'Site-fitted options — nature-based, engineering, monitoring — each with limitations, maturity and maintenance stated. No solution is presented as guaranteed prevention. <a class="text-link" href="intelligence.html?mode=siting">Match solutions →</a>'],
                    ['5 · Funding programmes', 'Which public programmes (EU and beyond) may fit your project — real programmes with official sources. Eligibility always requires verification; we never promise funding. <a class="text-link" href="intelligence.html?mode=funding">Find funding →</a>'],
