        ...
        government: {
            ...
            extra: {
                ...
                cards: [
                    ...
                    ['3 · Economic exposure', 'Which sectors and assets sit in exposed areas — structured exposure profiles for budget and planning conversations. Where no documented valuation basis exists, we say so instead of inventing figures. <a class="text-link" href="economy.html">Explore exposure →</a>'],
                    ...
                    ['5 · Funding programmes', 'Which public programmes (EU and beyond) may fit your project — real programmes with official sources. Eligibility always requires verification; we never promise funding. <a class="text-link" href="funding.html">Find funding →</a>'],
