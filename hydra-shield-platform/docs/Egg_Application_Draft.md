# The EGG (Greece) - Application Draft (Step 1)

**Program:** The EGG (Enter•Grow•Go) Accelerator
...
* DeepTech / High-Tech
* Earth Observation / SpaceTech
* Environmental & Social Impact
* Artificial Intelligence / Data Analytics

**Have you already set up a company to develop your idea?**
No *(Assuming the Luxembourg entity is not yet fully registered. Select 'Yes' only if you have the official company registration documents).*

---

## Required Documents Preparation

You need to download two files from the portal:
1. **Business plan template**
2. **Solemn declaration**

Below is the drafted content to help you fill in the **Business plan template**. Copy and paste these sections into the downloaded document.
...
* Municipalities and Regional Governments (especially in high-risk zones like Greece and Southern Europe).
* Civil Protection Agencies and Fire Departments.
* Critical Infrastructure Operators and Forestry Management.
...
**7. Team**
*(Provide a brief overview of your background, emphasizing your technical, business, or project management expertise, and state that the core team is currently being expanded to include AI researchers, GIS specialists, and soil scientists).*

**8. Why "the egg"?**
Greece is a frontline nation facing severe wildfire threats, making it an ideal environment for field validation and pilot deployment. We are applying to the EGG to access experienced mentors, networking opportunities within the Greek and broader European ecosystem, and the funding/investment tools needed to transition from our Digital Proof of Concept to a validated field prototype.

---
**Next Actions:**
1. Log into the portal.
2. Fill in the Step 1 fields.
3. Download the `Business plan template` and `Solemn declaration`.
4. Paste the text above into the Business Plan template and sign the Solemn declaration.
5. Upload the files and proceed to Step 2!