...
Wildfire events come from NASA FIRMS detections (per sensor, never merged).
Heat is a percentile against the 1991–2020 ERA5 climatology. Flood uses
GloFAS modelled discharge. Each hazard page says what is unavailable too —
a missing data key is shown, not worked around.
