...
| GRC phase tracker | 🔶 | `docs/GRC_COMPLIANCE.md`: Phase 1 🔶 (CsrdTX + XBRL live since 2026-09-05; ESRS E1 datapoint-coverage map + E1-9 financial-effects context next), Phase 2 🔶 (sustainability.html funnel sharpening + outreach next). Infosec = internal trust enabler only, never a service line |
