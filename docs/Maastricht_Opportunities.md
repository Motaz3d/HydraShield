...
## 2. Top Incubators & Accelerators in Maastricht / Limburg
...
### LIOF (Limburg Development Company)
*   **Overview:** LIOF is the regional development agency for Limburg and one of the most active startup investors in the Netherlands.
*   **Programs:** They offer a structured funding path from "Limburg Startup Capital Fund" (seed funding) to larger innovation projects.
*   **Benefits:** They provide highly favorable convertible loans and equity investments specifically for deep-tech and climate-tech companies settling in the region.
*   **Fit:** Essential for initial company formation and bridging the gap to larger EU grants.
...
*   **Benefits:** Offers "Feasibility Grants" (up to €20,000) and "R&D Collaboration Grants" (up to €350,000) for collaborative research projects.
*   **Fit:** Ideal for funding the Phase 1 Digital Feasibility studies and early-stage modeling in partnership with a Dutch university.

### NWO (Dutch Research Council) & RVO (Netherlands Enterprise Agency)
*   **Overview:** RVO is the national agency handling major innovation grants (like the Innovation Credit - *Innovatiekrediet*).
*   **Fit:** Relevant for later stages (Phase 2/3) when massive scale-up capital is required.

## 4. Recommended Action Plan for Maastricht

1.  **Immediate (0-3 Months):**
    *   Initiate contact with **Brightlands Smart Services Campus** (Heerlen/Maastricht) to secure soft-landing support and explore incubation.
    *   Engage with **LIOF** to discuss early-stage seed funding (Limburg Startup Capital Fund) tailored for climate-tech.
2.  **Short-Term (3-6 Months):**
    *   Incorporate an entity (B.V. - Besloten Vennootschap) in Maastricht.
    *   Apply immediately for the **WBSO** tax incentive to drastically reduce the cost of hiring local software and data engineering talent.
    *   Apply for an **MIT Feasibility Grant** to fund the initial digital twin architecture planning.
3.  **Mid-Term (6-12 Months):**
    *   Establish an R&D partnership with Maastricht University (Data Science) or a nearby hydrology institute.
